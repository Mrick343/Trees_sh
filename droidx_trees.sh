...
# Clone Device Tree
git clone -b droidx-13.1 https://github.com/Mrick343/android_device_oneplus_martini.git device/oneplus/martini

# Clone Common Tree
git clone -b droidx-13.1 https://github.com/Mrick343/android_device_oneplus_sm8350-common.git device/oneplus/sm8350-common
