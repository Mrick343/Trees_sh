...
# Clone Device Tree
git clone -b 14.0 https://github.com/Mrick343/device_oneplus_martini-pr.git device/oneplus/martini

# Clone Common Tree
git clone -b 14.0 https://github.com/Mrick343/android_device_oneplus_sm8350-common-pr.git device/oneplus/sm8350-common

# Clone Device Vendor
git clone -b fourteen https://github.com/Mrick343/proprietary_vendor_oneplus_martini.git vendor/oneplus/martini
