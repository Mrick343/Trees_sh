...
# Clone Device Tree
git clone -b pex-13.1 https://github.com/Mrick343/android_device_oneplus_martini.git device/oneplus/martini

# Clone Common Tree
git clone -b pex-13.1 https://github.com/Mrick343/android_device_oneplus_sm8350-common.git device/oneplus/sm8350-common
...
# Clone hardware
git clone -b pex-13.1 https://github.com/Mrick343/hardware_oneplus.git hardware/oplus
